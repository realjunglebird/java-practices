public class RoadBike extends Bike implements RoadParts {
    ...
    @Override
    public void setTyreWidth(String newValue) { tyreWidth = Integer.parseInt(newValue); }

    @Override
    public int getPostHeight() { return postHeight; }
    @Override
    public void setPostHeight(String newValue) { postHeight = Integer.parseInt(newValue); }
